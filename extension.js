...
function activate(context) {
    ...
    let figureDisposable = vscode.commands.registerCommand('extension.insertFigure', () => {
        ...
        vscode.window.showInputBox({
            ...
            .then(() => {
                return vscode.window.showQuickPick(cssWidthClassList, {
                    placeHolder: "Width Class"
                })
                    .then(result => {
            ...
            .then(() => {
                return vscode.window.showQuickPick(cssAlignmentClassList, {
                    placeHolder: "Alignment Class"
                })
                    .then(result => {
